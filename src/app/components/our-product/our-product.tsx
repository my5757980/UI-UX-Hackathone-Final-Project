...
export default function OurProduct() {
   return (
      <div className="overflow-x-hidden">
         ...
         <h1  className="text-center font-bold text-[22px] pb-[33px]  md:relative md:left-[-130px]  lg:relative lg:left-[-350px]">Our Product</h1>
         ...
         <div className="m-auto w-[200px] md:m-auto md:w-[450px]  lg:m-auto  lg:w-[900px]">
            <div className="md:grid md:gap-5 md:grid-cols-2   lg:grid  lg:gap-5  lg:grid-cols-4    mb-[33px]      flex flex-col gap-16">
               ...
               <div className="shadow-xl h-[280px]">
                  ...
                  <p className="relative bottom-[10px] font-bold">$20</p>
         ...
         <div className="md:grid md:gap-5 md:grid-cols-2   lg:grid  lg:gap-5  lg:grid-cols-4    mb-[33px]      flex flex-col gap-16">
               ...
               <div className="shadow-xl h-[280px] ">
                  <Image className="  " src="/image/Image (11).png" alt="logo" width={200} height={200} />
                  <div className="flex gap-6 pt-[8px]">
                     <h1 className="">Library Stool Chair</h1>
                     <BsCartDash className="w-[33px] h-[33px] bg-[#F0F2F3] rounded-[5px]" />
                  </div>
               ...
               <div className="shadow-xl h-[280px]     ">
                  <Image  src="/image/Image (5).png" alt="logo" width={200} height={200} />
                  <div className="flex gap-6 pt-[8px]">
                     <h1 className=" ">Library Stool Chair</h1>
                     <BsCartDash className="w-[33px] h-[33px] bg-[#F0F2F3] rounded-[5px]" />
                  </div>
