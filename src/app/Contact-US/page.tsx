      ...
      <div className="m-auto w-[200px] md:m-auto md:w-[450px] lg:m-auto lg:w-[600px]">
        <div className="md:grid md:gap-5 md:grid-cols-2">
          ...
          <div className="md:col-span-1 ">
            ...
            <input className="h-[44px] border-[2px]  pl-4  " placeholder="ABC" />




            <h1 className="pb-[11px] pt-[22px]">Email address</h1>
            <input className="h-[44px] border-[2px] pl-4" placeholder="Abc@def.com" />




            <h1 className="pb-[11px] pt-[22px]">Subject</h1>
            <input className="h-[44px] border-[2px] pl-4 " placeholder="This is an optional" />




            <h1 className="pb-[11px] pt-[22px]">Message</h1>
            <input className="h-[77px] border-[2px] pl-4 " placeholder="Hi! i’d like to ask about" />
            <br />
